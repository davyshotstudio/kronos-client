...
function SceneRouter:nextScene(currentState, nextState)
  ...
  local stateSceneMapper = {
    ...
    STATE_BATTER_ATHLETE_SELECT_PENDING = SCENE_TITLES.BATTER_ATHLETE_SELECTION_SCENE,
    STATE_BATTER_ZONE_CREATE = SCENE_TITLES.BATTER_STRIKE_ZONE_CREATION_SCENE,
    STATE_BATTER_ZONE_CREATE_PENDING = SCENE_TITLES.BATTER_STRIKE_ZONE_CREATION_SCENE,
    STATE_BATTER_SWING_SELECT = SCENE_TITLES.BATTER_SWING_SELECTION_SCENE,
    STATE_BATTER_SWING_SELECT_PENDING = SCENE_TITLES.BATTER_SWING_SELECTION_SCENE,
