local constants = {
  ...
  STATE_BATTER_ATHLETE_SELECT_PENDING = "STATE_BATTER_ATHLETE_SELECT_PENDING",
  STATE_BATTER_ZONE_CREATE = "STATE_BATTER_ZONE_CREATE",
  STATE_BATTER_ZONE_CREATE_PENDING = "STATE_BATTER_ZONE_CREATE_PENDING",
  STATE_BATTER_SWING_SELECT = "STATE_BATTER_SWING_SELECT",
  STATE_BATTER_SWING_SELECT_PENDING = "STATE_BATTER_SWING_SELECT_PENDING",
  ...
  ACTION_BATTER_SELECT_ATHLETE_READY = "ACTION_BATTER_SELECT_ATHLETE_READY",
  ACTION_BATTER_CREATE_ZONE = "ACTION_BATTER_CREATE_ZONE",
  ACTION_BATTER_CREATE_ZONE_READY = "ACTION_BATTER_CREATE_ZONE_READY",
  ACTION_BATTER_SELECT_ZONE = "ACTION_BATTER_SELECT_ZONE",
  ACTION_BATTER_SELECT_ZONE_READY = "ACTION_BATTER_SELECT_ZONE_READY",
